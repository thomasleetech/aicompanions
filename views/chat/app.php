    ...
    <div class="app-layout">
        ...
        <aside class="app-sidebar" id="sidebar">
            <div class="sidebar-header">
                <h2>Chats</h2>
                <a href="/browse" class="btn btn-sm btn-ghost">+ New</a>
            </div>
            ...
            <div class="conversation-list" id="conversationList">
                <?php if (empty($conversations)): ?>
                    <div class="empty-state-small">
                        ...
                        <a href="/browse" class="btn btn-sm btn-primary">Find a Companion</a>
                    </div>
                <?php endif; ?>
                <?php foreach ($conversations as $c): ?>
                <a href="/chat/<?= $c['gig_id'] ?>" class="conversation-item" data-gig="<?= $c['gig_id'] ?>">
            ...
            <div class="sidebar-section">
                ...
                <div class="discover-list">
                    ...
                    <a href="/chat/<?= $g['id'] ?>" class="discover-item">
        ...
        <div class="app-main">
            <div class="app-welcome">
                ...
                <a href="/browse" class="btn btn-primary">Browse Companions</a>
            </div>
        </div>
    </div>
</section>
